...
## Introduction
The Shamrock is a PCB-Celtic knot shaped like a shamrock with 20 LEDs. The LEDs are independently controlled by an ATTINY 13 using charlieplexing. Code is uploaded to the device with AVR dude using a Bus Pirate, a AVRisp mk II or similar. It is not Arduino compatible. It comes pre-programmed in the kit.
